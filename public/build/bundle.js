...
/***/ function(module, exports, __webpack_require__) {
	...
	var SVGLoader = __webpack_require__(149);
	var ticker = __webpack_require__(150);
	
	var serviceURL = "http://ftlabs-big-ft.herokuapp.com/data/";
	...
	function getStories(amount) {
		...
		return fetch(serviceURL + "/top-stories?startFrom=1&numberOfArticles=" + amount).then(function (response) {
	...
	function updateContent() {
		...
		getStories(10).then(function (stories) {
	
			interstitial.show();
	
			setTimeout(function () {
				return _Promise.all([populateMainStories(stories.slice(0, 3)), populateTicker(stories.slice(3, stories.length))]);
			}, 1000);
		}).then(function () {
